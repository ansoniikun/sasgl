    ...
    <footer className="bg-black text-white py-12 px-4 md:px-8 overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Golf Section */}
          <div>
            <h3 className="text-dark-gold text-xl font-bold mb-4">Golf</h3>
          ...
          {/* Events Section */}
          <div>
            <h3 className="text-dark-gold text-xl font-bold mb-4">Events</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="/tournaments"
          ...
          {/* Contact Us Section */}
          <div>
            <h3 className="text-dark-gold text-xl font-bold mb-4">
              Contact Us
            </h3>
          ...
          <div>
            ...
            >
              ...
              <button
                type="submit"
                className="bg-dark-gold text-black font-bold px-4 py-2 rounded hover:bg-yellow-600 transition w-full sm:w-auto"
              >
                SUBSCRIBE &gt;
              </button>
            </form>
